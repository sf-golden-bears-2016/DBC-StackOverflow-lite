...
Response.create(text: "This is an Response to a Question", responseable_id: 1, responseable_type: "question", user_id: 1)
Response.create(text: "This is an Response to an Answer", responseable_id: 1, responseable_type: "answer", user_id: 1)
